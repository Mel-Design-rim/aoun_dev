...
import 'package:aoun_dev/src/screens/projects_screen.dart';
import 'package:aoun_dev/src/screens/profile_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Method to get the appropriate body based on selected tab
  Widget _getBody() {
  ...
  Widget _buildHomeContent() {
    return SafeArea(
      child: Padding(
        padding: const EdgeInsets.only(top: 30, right: 10, left: 10, bottom: 0),
        child: Column(
